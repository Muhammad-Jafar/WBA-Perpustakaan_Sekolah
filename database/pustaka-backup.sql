...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 19, 2022 at 04:47 PM
...
(1, 10, 1, 'BUKU-00001', 'Pengantar Fisika Dasar', 'Robert Dawney Jr', 'MCU', '2018', 210, 10),
...
(4, 1, 1, 'BUKU-00004', 'Kimia Dasar untuk kelas X', 'Robert Dawney Jr', 'Gramedia', '2018', 260, 10);
...
(17, 4, 6, 0, '2022-06-24', '0000-00-00', 0, 0),
(18, 1, 1, 0, '2022-06-20', '0000-00-00', 0, 0);
...
(17, 'PJ-0017', 4, 6, 0, '2022-06-19', '2022-06-24', '0000-00-00', 'dipinjam', 1),
(18, 'PJ-0018', 1, 1, 0, '2022-06-15', '2022-06-20', '0000-00-00', 'dipinjam', 1);
...
ALTER TABLE `guru`
  ...
  ADD KEY `id_kategori_anggota` (`id_kategori_anggota`);
...
--
ALTER TABLE `denda`
  MODIFY `id_transaksi` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `transaksi`
  MODIFY `id_transaksi` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `guru`
  ADD CONSTRAINT `guru_ibfk_1` FOREIGN KEY (`id_kategori_anggota`) REFERENCES `kategori_anggota` (`id_kategori_anggota`);

--
-- Constraints for table `siswa`
--
ALTER TABLE `siswa`
  ADD CONSTRAINT `siswa_ibfk_1` FOREIGN KEY (`id_kategori_anggota`) REFERENCES `kategori_anggota` (`id_kategori_anggota`);
