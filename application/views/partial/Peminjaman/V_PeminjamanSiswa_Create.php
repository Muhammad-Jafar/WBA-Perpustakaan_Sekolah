                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id='namasiswa' name="nama_anggota" placeholder="Cari nama siswa">
                        <input type="hidden" class="form-control" id='idsiswa' name="id_anggota">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
